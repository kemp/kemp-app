export default {
    'projects': [
        ...
        { 
            ...
            description: 'A simple Electron interface for placing an order at a restaurant.',
            keywords: ['Javascript', 'Electron'],
            date: '2020',
            sourceUrl: 'https://github.com/kemp/food-ordering-app'
        },
        { 
            name: 'VideoMirror Chrome Extension', 
            description: 'Leading solution allowing you to flip (left-to-right) videos on a webpage. It has 4.7 stars and over 500,000 users on the Chrome Web Store.', 
            keywords: ['Browser extension', 'Javascript', 'Live'],
            date: '2020',
        ...
        { 
            ...
            description: 'A programming language processor for Julia. It processes the code in three steps: scanning, parsing, and finally interpreting.',
            date: '2019',
            keywords: ['Java', 'JuliaLang', 'Test-driven development', 'Programming concepts', 'Team'], 
            sourceUrl: 'https://github.com/kemp/java-julia-processor'
        },
        { 
